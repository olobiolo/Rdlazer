...
- you query the dta table that is to be kept with the other data table in `i`
...
An empty bracket will print a data table. This is often useful when modifyinf by reference:
```{r}
