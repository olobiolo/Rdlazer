...
<h4> A data frame is a special kind of list made up of atomic vectors. <br>
Extracting rows and columns is reobust. <br>
Operations on columns are easy.
</h4>
...
**Wherefore the factors?**<br> Factors store **categorical data**. It used to be a very useful way to encode what is called discreet variables. Today much of what factors do can be don eby character vectors just as well but many procedures rely on a factor input, so they are not going away any time soon.
